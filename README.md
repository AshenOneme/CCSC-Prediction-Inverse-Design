...
The predictive model we developed, which maps column cross-sectional properties to mechanical performance, demonstrates robust predictive capabilities. In Figure 3, the blue line represents the results of numerical simulations, while the line depicts the predicted outcomes generated by the ViT model.
<div align=center>
